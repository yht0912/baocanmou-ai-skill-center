export const resources = {
  en: {
    translation: {
      ...
      tagListTitle: 'Tags',
      tagCount: '{{count}} tags',
      navMySkills: 'Managed Skills',
      navPopularLibrary: 'Popular Library',
      navExplore: 'Explore',
      navTags: 'Tags',
      navTools: 'Tools',
      ...
      exploreSourceHint: 'BaoCanMou selection: installs + GitHub signals + maintenance + licensing · Reviewed twice weekly · Type 2+ characters to search',
      exploreFeaturedTitle: 'BaoCanMou Skill Recommendations',
      exploreOnlineTitle: 'Online Results',
      popularityDisclaimer: 'Recommendation scores support discovery. They are transparent BaoCanMou judgments, not GitHub user ratings or security certification.',
      popularitySortLabel: 'Sort popular skills',
      popularitySort: {
        composite: 'BaoCanMou score',
        installs: 'Installs',
        stars: 'GitHub stars',
      },
      popularityRank: 'BaoCanMou recommendation rank {{rank}}',
      ...
      recommendationScore: 'BaoCanMou recommendation score',
      recommendationTier: 'Recommendation tier {{tier}}',
      recommendationReasonLabel: 'Selection reasons',
      recommendationReasons: {
        highAdoption: 'High adoption',
        fastMomentum: 'Fast growth',
        communityRecognition: 'Community recognized',
        activelyMaintained: 'Actively maintained',
        officialSource: 'Official source',
        clearLicense: 'Clear license',
        baocanmouFit: 'BaoCanMou fit',
      },
  ...
  zh: {
    translation: {
      ...
      exploreSource: '数据来自',
      exploreSourceHint: '包参谋精选：安装量 + GitHub 信号 + 维护度 + 许可信息 · 每周复筛两次 · 输入 2 个字符开始搜索',
      exploreFeaturedTitle: '包参谋技能推荐榜',
      exploreOnlineTitle: '在线搜索',
      popularityDisclaimer: '推荐分是包参谋可解释的筛选判断，不是 GitHub 用户评分，也不代表安全认证。',
      ...
      popularityRank: '包参谋推荐榜第 {{rank}} 名',
      popularityOfficial: '官方',
      popularitySkillSummary: '根据公开安装量与 GitHub 仓库信号收录的热门 AI 技能。',
      recommendationScore: '包参谋推荐分',
      recommendationTier: '推荐等级 {{tier}}',
      recommendationReasonLabel: '入选理由',
      recommendationReasons: {
        highAdoption: '安装量高',
        fastMomentum: '近期增长快',
        communityRecognition: '社区认可',
        activelyMaintained: '持续维护',
        officialSource: '官方来源',
        clearLicense: '许可明确',
        baocanmouFit: '契合包参谋',
      },
