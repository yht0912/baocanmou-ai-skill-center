...
const GitPickModal = ({
  ...
  const filteredCandidates = useMemo(() => {
    ...
    return gitCandidates.filter((c) =>
      [c.name, getSkillDisplayNames(c.name, c.description).primary, c.description ?? '', c.subpath].some((value) =>
        ...
        <div className="modal-body">
          ...
          <div className="pick-list">
            ...
            {filteredCandidates.map((c) => {
              const displayNames = getSkillDisplayNames(c.name, c.description)
              return <div className="pick-item" key={c.subpath}>
