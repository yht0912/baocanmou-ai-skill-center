...
const ImportModal = ({
  ...
  const filteredGroups = useMemo(() => {
    ...
    return plan.groups.filter((group) => {
      const fields = [
        group.name,
        getSkillDisplayNames(group.name).primary,
        ...
        <div className="modal-body">
          ...
          <div className="groups discovered-list">
            ...
            {filteredGroups.map((group) => {
              const displayNames = getSkillDisplayNames(group.name)
              return <div className="group-card" key={group.name}>
                <div className="group-title">
                  <label className="group-select">
                    ...
                    />
                    <span className="import-bilingual-name">
